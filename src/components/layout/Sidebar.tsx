...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return <div className="flex flex-col h-full py-4 text-gray-800 dark:text-gray-200">
    ...
    <div className="px-2 mt-6">
      <button onClick={() => { logout(); closeSidebar(); }} className="flex items-center w-full px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-200 rounded-xl hover:bg-lightgreen dark:hover:bg-gray-800">
