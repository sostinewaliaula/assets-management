        ...
        <div className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
          <div className="w-full">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="button-primary block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center" disabled={isLoading}>{isLoading ? 'Sending...' : 'Recover Password'}</button>
            </form>
            <hr className="my-8" />
            <p className="mt-4">
